...
left join user us on rep.user_id = us.user_id where status = 1 and unit_id='" . $unit_id . "'";
...
$sql2 = "SELECT * from report where revision_count >0 and user_id='" . $unit_id . "'";
...
$sql4 = "SELECT * from user where unit_id = '" . $unit_id . "'";
        ...
        <div class="row">
            ...
            <div class="card info-card sales-card">
              ...
              <div class="card-body">
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div class="ps-3">
                    <h6><?= $pending_count ?></h6><span class="text-muted small pt-2 ps-1">Pending Report</span>
          ...
          <div class="col-xxl-3 col-md-6">
            <div class="card info-card revenue-card">
              ...
              <div class="card-body">
                <h5 class="card-title">Report <span>| for Revision</span></h5>
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div class="ps-3">
                    ...
                    <span class="text-success small pt-1 fw-bold"></span><span class="text-muted small pt-2 ps-1">Revise Report</span>
          ...
          <div class="col-xxl-3 col-xl-12">
            <div class="card info-card users-card">
              ...
              <div class="card-body">
                <h5 class="card-title">User <span>| <?= $unit ?></span></h5>
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div class="ps-3">
                    <h6><?= $user_count ?></h6>
                    <span class="text-muted small pt-2 ps-1"><?= $unit ?> User</span>
                  </div>
                </div>
              </div>
            </div>
