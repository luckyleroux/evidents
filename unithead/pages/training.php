        ...
        <div class="card">
          <div class="card-body">
            ...
            <table class="table table-borderless datatable">
              ...
              <tbody>
                <?php
                $sql = "SELECT * from report rep left join user us on us.user_id = rep.user_id left join unit_details ud on ud.unit_id = us.unit_id where report_type = 2 && us.unit_id = '" . $unit_id . "'|| report_type=2 && status = 3 &&shared=1||report_type=2 && status = 3 && shared=2&&shared_unit = '" . $unit_id . "'";
