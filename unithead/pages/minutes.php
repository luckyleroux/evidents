          ...
          <div class="card-body">
            ...
            <table class="table table-borderless datatable">
              ...
              <tbody>
                ...
                left join unit_details ud on ud.unit_id = us.unit_id where report_type = 1 && us.unit_id = '" . $unit_id . "'|| report_type=1 && status = 3 &&shared=1||report_type=1 && status = 3 && shared=2&&shared_unit = '" . $unit_id . "'";
