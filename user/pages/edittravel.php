                        ...
                        <form class="row g-3" id="add_travel">
                            <div class="col-md-12">
                                ...
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="requesting" id="requesting" value="<?= $requesting_organizer ?>" placeholder="Requesting Organizer">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <textarea style="height: 100px;" class="form-control" id="concerns" name="concerns" placeholder="Concerns"><?= $concern ?></textarea>
                                    <label for="concerns">S&T Related Issues and Concerns raised</label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <textarea type="text" style="height: 100px;" class="form-control" id="followup" name="followup" placeholder="Followup"><?= $follow_up_act ?></textarea>
                                    <label for="followup">Follow-up Activities <span style="color:red;">*</span></label>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <textarea type="text" class="form-control" style="height: 100px;" id="importance" name="importance" placeholder="Importance of the activity"><?= $importance_of_the_activity ?></textarea>
                                    <label for="importance">Importance of the activity to your job</label>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-floating">
                                    <input type="date" class="form-control" id="submitted" name="submitted" placeholder="Date Submitted" value="<?= $date_submitted ?>">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById("add_travel").addEventListener("submit", function(e) {
                ...
                fetch("backend/revise_travel.php", {
                        method: "POST",
                        headers: {
