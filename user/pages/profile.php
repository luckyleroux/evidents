                            ...
                            <div class="tab-pane fade profile-edit pt-3 show active" id="profile-edit">
                                ...
                                <form method="POST" action="backend/updateprofile.php">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="fullname" type="text" class="form-control" id="fullname" value="<?= sanitizeQuillContent($fname) ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="division" type="text" class="form-control" id="division" value="<?= $division ?> (<?= $division_acr ?>)" disabled>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="email" type="email" class="form-control" id="Email" value="<?= sanitizeQuillContent($email) ?>">
                                        </div>
                                    </div>
...
if (isset($_GET['status'])) {
    if ($_GET['status'] == 1) {
        echo '<script>const Toast = Swal.mixin({
          ...
          Toast.fire({
            icon: "success",
            title: "Password has successfully changed"
          });    
      </script>';
