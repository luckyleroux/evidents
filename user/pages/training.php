        ...
        <div class="card">
          <div class="card-body">
            ...
            <table class="table table-borderless datatable">
              ...
              <tbody>
                <?php
                $sql = "SELECT * from report rep left join user us on us.user_id = rep.user_id left join unit_details ud on ud.unit_id = us.unit_id where report_type = 2 && ud.unit_id = '" . $unit_id . "'";
                    ...
                    <tr>
                      ...
                      <td><?php
                        ...
                        <?php
                          ...
                          <a href="edittraining.php?id=<?= $row['report_id'] ?>" type="button" class="btn btn-warning btn-sm" title="Edit report">
