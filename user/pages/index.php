...
$revision_count = 0;
$approved_count = 0;
$sql1 = "SELECT * from report where status = 1 and user_id='" . $_SESSION['id'] . "'";
...
$sql2 = "SELECT * from report where revision_count >0 and user_id='" . $_SESSION['id'] . "'";
...
$sql3 = "SELECT * from report where status = 2 && revision_count = 0 && user_id='" . $_SESSION['id'] . "' || status = 3 && revision_count = 0 && user_id='" . $_SESSION['id'] . "'";
        ...
        <div class="row">
          ...
          <div class="col-xxl-4 col-md-6">
            <div class="card info-card sales-card">
              <div class="card-body">
                <h5 class="card-title">Pending <span>| Report </span></h5>
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div class="ps-3">
                    <h6><?php
                        echo $pending_count;
                        ?></h6>
                    <span class="text-success small pt-1 fw-bold"></span> <span class="text-muted small pt-2 ps-1">Encoded Report</span>
          ...
          <div class="col-xxl-4 col-md-6">
            <div class="card info-card revenue-card">
              <div class="card-body">
                <h5 class="card-title">Revision <span>| Report</span></h5>
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div class="ps-3">
                    ...
                    <span class="text-danger small pt-1 fw-bold"></span> <span class="text-muted small pt-2 ps-1">For Revision Report</span>
          ...
          <div class="col-xxl-4 col-xl-12">
            ...
            <div class="card info-card customers-card">
              ...
              <div class="card-body">
                <h5 class="card-title">Approved <span>| Report </span></h5>
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div class="ps-3">
                    ...
                    <span class="text-danger small pt-1 fw-bold"></span> <span class="text-muted small pt-2 ps-1">Approved report</span>
