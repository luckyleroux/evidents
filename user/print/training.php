    ...
    <div class="card-body">
        <table class="table table-bordered">
            <tbody>
                ...
                <tr>
                    <th style="border: 1px solid #ddd; padding: 8px;">Date conducted:</th>
                    <td style="border: 1px solid #ddd; padding: 8px; page-break-inside: avoid;"><?= date_format(date_create($conduct), "F d, Y") ?></td>
                </tr>
                <tr>
                    <th style="border: 1px solid #ddd; padding: 8px;">Implementing agency:</th>
                    <td style="border: 1px solid #ddd; padding: 8px; page-break-inside: avoid;"><?= $imp_agency ?></td>
                </tr>
                <tr>
                    <th style="border: 1px solid #ddd; padding: 8px;">Person's who attended:</th>
                    <td style="border: 1px solid #ddd; padding: 8px; page-break-inside: avoid;"><?= $person_attend ?></td>
                </tr>
                <tr>
