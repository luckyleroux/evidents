                            ...
                            <div class="tab-pane fade profile-edit pt-3 show active" id="profile-edit">
                                ...
                                <form method="POST" action="backend/updateprofile.php">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="fullname" type="text" class="form-control" id="fullname" value="<?= ucfirst($fname) ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="unit" type="text" class="form-control" id="unit" value="<?= $unit ?>" disabled>
                                        </div>
                                    </div>
