        ...
        <div class="card">
          <div class="card-body">
            ...
            <table class="table table-borderless datatable">
              ...
              <tbody>
                <?php
                $sql = "SELECT * from report rep left join user us on us.user_id = rep.user_id left join unit_details ud on ud.unit_id = us.unit_id where report_type = 1 && status = 2 || report_type=1 && status=3";
                    ...
                    <tr>
                      ...
                      <td><?php
                          switch ($row['status']) {
                            ...
                            case 2:
                              if ($row['revision_count'] == 0) {
                                echo "<span class='badge bg-warning'>Approved by Unit Head</span>";
                              } else {
                      ...
                      <td>
                        ...
                        <?php
                          ...
                          <a href="revise_minutes.php?id=<?= $row['report_id'] ?>" type="button" class="btn btn-danger btn-sm" title="Revise report">
