...
if (mysqli_num_rows($result) > 0) {
    ...
    $sql = "INSERT INTO user (username, password, userfname, date_encoded)
      VALUES ('" . strtoupper($_POST["regusername"]) . "','" . password_hash(sha1($_POST["regpass"]), PASSWORD_BCRYPT, ['cost' => 12]) . "','" . $_POST["regname"] . "','" . date("Y-m-d | H:i:s") . "')";
