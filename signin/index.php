                                    ...
                                    <div class="center-wrap">
                                        <div class="section text-center">
                                            ...
                                            <form action="check/check.php" method="POST">
                                                ...
                                                <a href="forgotpass.php" class="btn mt-4">Forgot Password</a>
                                    ...
                                    <div class="center-wrap">
                                        <div class="section text-center">
                                            ...
                                            <form action="check/register.php" method="POST">
                                                <div class="form-group">
                                                    <input type="text" name="regname" class="form-style" placeholder="Enter Full Name" id="regname" autocomplete="off">
